...
<body>
            ...
            <nav class="sidebar-nav">
                <ul class="nav flex-column">
                    <li class="nav-item">
                      ...
                      <!-- Nuevo: Perfil -->
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('profesor.perfil') }}" data-page="perfil">
 ...
 <style>
        :root {
            ...
            --shadow-medium: 0 8px 30px rgba(2, 73, 187, 0.15);
            --shadow-strong: 0 15px 35px rgba(2, 73, 187, 0.2);
        }
 ...
 <div class="main-container">
        <div class="profile-card">
            ...
            <div class="profile-header">
                <img src="https://i.pinimg.com/736x/69/45/01/6945015ecb9867fff7d5e0c1196f9d5a.jpg" 
                     alt="Profesor" class="profile-image">
                <h1 class="profile-title">Perfil del Profesor</h1>
            ...
            <div class="profile-body">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <span>{{ $profesor->name }} {{ $profesor->apellido_p }} {{ $profesor->apellido_m }}</span>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <span>{{ $profesor->fecha_nacimiento }}</span>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <span>{{ ucfirst($profesor->genero) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <form method="POST" action="{{ route('profesor.perfil.update') }}" id="updateForm">
                        @csrf
                        
                        <div class="form-floating">
                            <input type="email" class="form-control" id="email" name="email" 
                                   placeholder="correo@ejemplo.com" value="{{ old('email', $profesor->email) }}" required>
                        ...
                        <div class="form-floating">
                            <input type="tel" class="form-control" id="telefono" name="telefono" 
                                   placeholder="Número de teléfono" value="{{ old('telefono', $profesor->telefono) }}">
    ...
    <script>
        ...
        function showSuccessToast() {
            ...
            // Ocultar el contenedor después de que se cierre el toast
